...
- **Cheap model for simple subagents** — when spawning a subagent for exploration, file reading, file search, or other simple lookup work, always use `model: "haiku"`. Only use the default/heavier model when the subagent must do real reasoning, design, or multi-step implementation.
